...
function updatePaymentDetails() {
  ...
  if (selectedMethod.value === 'card') {
    paymentDetails.innerHTML = '<div class="payment-row"><label>カード番号</label><div class="payment-row half"><input type="text" id="cardNumber1" maxlength="4" placeholder="0000" inputmode="numeric"><input type="text" id="cardNumber2" maxlength="4" placeholder="0000" inputmode="numeric"><input type="text" id="cardNumber3" maxlength="4" placeholder="0000" inputmode="numeric"><input type="text" id="cardNumber4" maxlength="4" placeholder="0000" inputmode="numeric"></div></div><div class="payment-row half"><label>有効期限</label><select id="cardExpiryMonth"></select><select id="cardExpiryYear"></select></div><div class="payment-row"><label>セキュリティコード</label><input type="text" id="cardCvc" maxlength="4" placeholder="123" inputmode="numeric"></div>';
